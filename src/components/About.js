  ...
  return (
    <div className='container' style={{color : props.mode === 'dark'?'white':'#0f1544',}}>
        ...
        <div className="accordion-item" style={myStyle}>
            ...
            <button className="accordion-button newFont" style={myStyle} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                Analize your text
            </button>
            </h2>
            <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            <div className="accordion-body aboutContextFont" style={myStyle}>
        ...
        <div className="accordion-item" style={myStyle}>
            ...
            <button className="accordion-button collapsed newFont" style={myStyle} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                Free to use
            </button>
            </h2>
        ...
        <div className="accordion-item" style={myStyle}>
            ...
            <button className="accordion-button collapsed newFont" style={myStyle} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                Browser Compatible
            </button>
            </h2>
